# [Одностраничный сайт  >>](https://efremandre.github.io/eskbeton/dist/)

## Задачи
Создать платформу, для привлечения клиентов через рекламу и представительства компании по монтажу бетонных полов ЕСК-Бетон в интернете.
